    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                fixed DistanceInRect(float2 pPos, float2 pClipRectXY, float2 pClipRectZW)
                {
                    /*  if(pClipRectXY)
                      pPos =step(pClipRectXY, pPos) * step(pPos, pClipRectZW);*/
                      return pPos.x * pPos.y;
                  ...
                  fixed SampleAlpha(int pIndex, v2f IN)
                  {
                      ...
                      return IsInRect(pos, IN.uvOriginXY, IN.uvOriginZW) * (tex2D(_MainTex, pos) + _TextureSampleAdd).w * _OutlineColor.w * 0.8;
                  }
